...
def train(args):
    ...
    if True:
        ...
        print(f"Loanding quantized encoder model: {args.encoder}")

        encoder_model = AutoModel.from_pretrained(args.encoder, 
        ...
        model = LM_QAGNN(args, encoder_model, k=args.k, n_ntype=4, n_etype=args.num_relation, n_concept=concept_num,
